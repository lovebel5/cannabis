        ...
        <div class="container-fluid">
            <div class="header-mobile-inner">
                <a class="logo" href="{{url('admin')}}">
                    <img src="{{url('images/icon/logo.png')}}" alt="Herbal Health Tourism Phuket"/>
                </a>
...
<aside class="menu-sidebar d-none d-lg-block">
 ...
 ">
        <a href="{{url('admin')}}">
            <img src="{{url('images/icon/logo.png')}}" alt="Herbal Health Tourism Phuket" style="height: 52px"/>
        </a>
    </div>
    <div class="menu-sidebar__content js-scrollbar1">
        <nav class="navbar-sidebar">
            <ul class="list-unstyled navbar__list">
                <li class="active has-sub" style="display: none">
                    <a class="js-arrow" href="#">
                        <i class="fas fa-tachometer-alt"></i>Cannabis Plant</a>
