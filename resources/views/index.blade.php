...
<head>
    ...
    <!-- Icon -->
    <link rel="stylesheet" type="text/css" href="{{url('assets/fonts/simple-line-icons.css')}}">
    <!-- Slicknav -->
    <link rel="stylesheet" type="text/css" href="{{url('assets/css/slicknav.css')}}">
    <!-- Menu CSS -->
    <link rel="stylesheet" type="text/css" href="{{url('assets/css/menu_sideslide.css')}}">
    <!-- Slider CSS -->
    <link rel="stylesheet" type="text/css" href="{{url('assets/css/slide-style.css')}}">
    <!-- Nivo Lightbox -->
    <link rel="stylesheet" type="text/css" href="{{url('assets/css/nivo-lightbox.css')}}" >
    <!-- Animate -->
